...
{      char str[100];
	...
	//wall
	ShowBMP(0,430,"Game-M~1/wall.BMP");
	ShowBMP(256,430,"Game-M~1/wall.BMP");
	//img pillar
	ShowBMP(393,379,"Game-M~1/obj.BMP");

	//img
	ShowBMP(400,143,"Game-M~1/cgg_img2.BMP");
	//img moon
	ShowBMP(570,3,"Game-M~1/moon.BMP");
